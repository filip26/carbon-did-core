...
public final class MultiKeyResolver {
    ...
    private final Map<String, byte[]> codecs;
    ...
    public byte[] getPublicKey(String vm, String purpose, String algorithm, Instant timestamp) {
        ...
        var codeVarint = codecs.get(algorithm);
        ...
        if (did.fragment() != null) {
            ...
            if (method instanceof MultiKey multikey) {
                ...
                if (!hasPrefix(codeVarint, multikey.publicKey())) {
                    throw new IllegalArgumentException();
                }
                ...
                return decode(codeVarint, multikey.publicKey());
            }
            ...
            for (var method : methods) {
                if (method instanceof MultiKey multikey
                        && hasPrefix(codeVarint, multikey.publicKey())
    ...
    public static class Builder {
        ...
        public Builder codec(String algorithm, byte[] codeVarint) {
            codecs.put(algorithm, codeVarint);
            return this;
        }
    ...
    private static boolean hasPrefix(byte[] codeVarint, byte[] encoded) {
