 ...
 * </p>
 */
public record GenericDid(
        String method,
        String methodSpecificId) implements Did {

    private static final long serialVersionUID = -3619989957471336651L;
    ...
    public static boolean isDid(final URI uri) {
        ...
        if (!GenericDid.SCHEME.equals(uri.getScheme())
    ...
    public static boolean isDid(final String uri) {
        ...
        return parts.length == 3
                && GenericDid.SCHEME.equals(parts[0])
     ...
     */
    public static GenericDid from(final URI uri) {
     ...
     * @throws NullPointerException     if {@code uri} is {@code null}
     */
    public static GenericDid parse(final String uri) {
        ...
        if (!GenericDid.SCHEME.equals(parts[0])) {
            throw new IllegalArgumentException(
                    "The URI [" + uri + "] is not a valid DID; it must start with the 'did:' prefix.");
        }
     ...
     */
    public static GenericDid of(final String methodName, final String methodSpecificId) {
        ...
        return new GenericDid(methodName, methodSpecificId);
    }
